...
Begin VB.Form Form1 
   Caption         =   "基于电子标签和AGV技术的图书馆智能书籍归位系统 上海市金山中学 顾子安 徐晟秋"
   ClientHeight    =   9225
   ClientLeft      =   5775
   ClientTop       =   1950
   ClientWidth     =   13890
   ...
   EndProperty
   Icon            =   "18.1.30.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "18.1.30.frx":25CA
   ScaleHeight     =   6.406
   ScaleMode       =   5  'Inch
   ScaleWidth      =   9.646
...
c = "Select sn,name,isbn From book where id= '" + Text1.Text + "'"            '以ID为参考对象从数据库取值
