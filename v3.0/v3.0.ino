/*
                        基于RFID系统的智能图书馆书籍自动归位系统V3.0
                                        (霍尔传感器版)
            本程序版权归 上海市金山中学 顾子安 徐晟秋 所有，应用于 基于RFID系统的智能图书馆书籍自动归位系统V3.0
                         硬件核心：徐晟秋            软件核心：顾子安
...
char sRecog[SUM][30] = {"ni hao xiao hei", "kai deng", "guan deng", "qian jin", "zuo zhuan", "hou tui", "ting zhi"}; //定义二维数组，第二个值为每个关键词的最大字母数,Voice Recognize芯片用
